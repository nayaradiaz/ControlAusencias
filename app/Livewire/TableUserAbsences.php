...
class TableUserAbsences extends Component
{
    ...
    {
        $this->absences = Absence::with('department') // Relación con departamento
            ->where('user_id', Auth::id()) // Filtra solo por el usuario autenticado
            ->orderBy('date', 'desc')
            ->get();
    }
    ...
    public function render()
    {
        ...
        return view('livewire.table-user-absences');
    }
}
